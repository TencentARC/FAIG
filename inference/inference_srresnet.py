...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='experiments/srresnet/target_model.pth')
    parser.add_argument('--dataroot', type=str, default='datasets/Set14', help='gt image folder')
    parser.add_argument(
        '--save_root', type=str, default='results/Interpret/srresnet-targetmodel-sr', help='save folder')
