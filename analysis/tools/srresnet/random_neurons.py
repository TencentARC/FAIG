...
if __name__ == '__main__':
    ...
    parser.add_argument('--total_neuron_nums', type=int, default=151936, help='the number of filters in srresnet')
    parser.add_argument(
        '--record_filters_folder',
        type=str,
        default='results/Interpret/neuron-search/srresnet/Set14/random',
