...
def main():
    ...
    parser.add_argument('--net_type', type=str, default='srcnn_style', help='network type')
    ...
    parser.add_argument(
        '--srcnn_gradient_save_folder',
        type=str,
        default='results/Interpret/gradient/srcnn_style',
        help='folder that saves the gradient map')
    parser.add_argument(
        '--srcnn_metric_save_folder',
        type=str,
        default='results/Interpret/metrics/srcnn_style',
        help='folder that saves the gradient difference')
    parser.add_argument(
        '--target_model_output_root',
        type=str,
        default='results/Interpret/srcnn-targetmodel-sr',
    ...
    srcnn_gradient_save_folder = args.srcnn_gradient_save_folder
    srcnn_metric_save_folder = args.srcnn_metric_save_folder
    ...
    save_mask_faig_filters_folder = f'{srcnn_neuron_folder}/{dataset}/faig'
    ...
    save_mask_ig_filters_folder = f'{srcnn_neuron_folder}/{dataset}/ig'
    ...
    os.makedirs(f'{srcnn_metric_save_folder}/{dataset}', exist_ok=True)

    save_faig_maskdeblurfilter_blur_txt = f'{srcnn_metric_save_folder}/{dataset}/faig_maskdeblurfilter_blur.txt'
    save_faig_maskdenoisefilter_blur_txt = f'{srcnn_metric_save_folder}/{dataset}/faig_maskdenoisefilter_blur.txt'

    save_ig_maskdeblurfilter_blur_txt = f'{srcnn_metric_save_folder}/{dataset}/ig_maskdeblurfilter_blur.txt'
    save_ig_maskdenoisefilter_blur_txt = f'{srcnn_metric_save_folder}/{dataset}/ig_maskdenoisefilter_blur.txt'

    save_abs_filter_change_maskdeblurfilter_blur_txt = f'{srcnn_metric_save_folder}/{dataset}/abs_filter_change_maskdeblurfilter_blur.txt'  # noqa E501
    save_abs_filter_change_maskdenoisefilter_blur_txt = f'{srcnn_metric_save_folder}/{dataset}/abs_filter_change_maskdenoisefilter_blur.txt'  # noqa E501

    save_random_maskdeblurfilter_blur_txt = f'{srcnn_metric_save_folder}/{dataset}/random_maskdeblurfilter_blur.txt'
    save_random_maskdenoisefilter_blur_txt = f'{srcnn_metric_save_folder}/{dataset}/random_maskdenoisefilter_blur.txt'
    ...
    save_faig_maskdeblurfilter_noise_txt = f'{srcnn_metric_save_folder}/{dataset}/faig_maskdeblurfilter_noise.txt'
    save_faig_maskdenoisefilter_noise_txt = f'{srcnn_metric_save_folder}/{dataset}/faig_maskdenoisefilter_noise.txt'

    save_ig_maskdeblurfilter_noise_txt = f'{srcnn_metric_save_folder}/{dataset}/ig_maskdeblurfilter_noise.txt'
    save_ig_maskdenoisefilter_noise_txt = f'{srcnn_metric_save_folder}/{dataset}/ig_maskdenoisefilter_noise.txt'

    save_abs_filter_change_maskdeblurfilter_noise_txt = f'{srcnn_metric_save_folder}/{dataset}/abs_filter_change_maskdeblurfilter_noise.txt'  # noqa E501
    save_abs_filter_change_maskdenoisefilter_noise_txt = f'{srcnn_metric_save_folder}/{dataset}/abs_filter_change_maskdenoisefilter_noise.txt'  # noqa E501

    save_random_maskdeblurfilter_noise_txt = f'{srcnn_metric_save_folder}/{dataset}/random_maskdeblurfilter_noise.txt'
    save_random_maskdenoisefilter_noise_txt = f'{srcnn_metric_save_folder}/{dataset}/random_maskdenoisefilter_noise.txt'
